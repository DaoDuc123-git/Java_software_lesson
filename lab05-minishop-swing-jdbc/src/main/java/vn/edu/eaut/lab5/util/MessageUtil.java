...
public class MessageUtil {
    ...
    public static boolean showConfirm(String message) {
        return JOptionPane.showConfirmDialog(null, message, "Xac nhan", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION;
    }

    public static class PhoneDocumentFilter extends DocumentFilter {
        @Override
